...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <form action="{{ route('registration.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            <img src="{{ url('/gambar/ukuran.jpeg') }}" alt="Gambar Toga" class="w-90 h-auto mx-auto mb-4">
        ...
        <div id="campusNote" class="hidden mt-4 text-sm text-gray-600 bg-red-100 p-4 border-l-4 border-red-500">
            **Note: Berlaku bagi anda yang melakukan pendaftaran sebelum Sabtu, 23 Nov 2024. Lewat dari tanggal
            tersebut, silakan ambil di Kampus (Hubungi Tim pendaftaran untuk jadwal pengambilan).
        </div>
        ...
        <div class="mb-4 flex items-center">
            ...
            <label for="agreement" class="text-sm text-gray-700">
                "Dengan ini saya menyatakan bahwa data yang telah saya isi di atas adalah benar dan akurat sesuai dengan
                kondisi sebenarnya. Apabila di kemudian hari ditemukan ketidaksesuaian atau kesalahan pengisian, saya
                bersedia menerima konsekuensi yang ditetapkan".
            </label>
        </div>
        <button type="submit"
